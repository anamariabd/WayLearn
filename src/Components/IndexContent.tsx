                        ...
                        <div id="carouselExampleSlidesOnly" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <img className="d-block w-100" src={Niños} alt="First slide"></img>
                                </div>
                                <div className="carousel-item">
                                    <img className="d-block w-100" src={Niños} alt="Second slide"></img></div>
                                </div>
                                <div className="carousel-item">
                                    <img className="d-block w-100" src={Niños} alt="Third slide"></img>
                                </div>
                            </div>
                        </div>
                    </div>
